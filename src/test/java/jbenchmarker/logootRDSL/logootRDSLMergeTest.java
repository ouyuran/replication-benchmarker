...
import jbenchmarker.factories.LogootRDSLFactory;
...
public class logootRDSLMergeTest {
    private static final int REPLICA_ID = 7;
    private LogootRDSLMerge replica;

    @Before
    public void setUp() throws Exception {
        replica = (LogootRDSLMerge) new LogootRDSLFactory().create(REPLICA_ID);
    }
